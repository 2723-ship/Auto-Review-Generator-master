...
if __name__ == '__main__':
    #解析本地PDF文本，保存到本地TXT
    folder = 'D:/ENDNOTE X9/20210108转移库/My EndNote Library Copy.Data/PDF/2794426663' # 需要读取pdf的文件夹的路径，注意为绝对路径，如：E:/论文
    write_txt_file = 'result.txt' # 保存结果的文件，为txt文件
    appKey = '1017dbcedfa5eec4'  # 应用id
    appSecret = 'hdXN1zOUAx7WcgT0jld9W7WztzluwJH6'  # 应用密钥
